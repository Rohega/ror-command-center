...
4. App builder (kit decision, not the warehouse example): [ADR-0006](architecture/adr-0006-app-builder-outside-rorcc-inside.md) · [ADR-0007](architecture/adr-0007-action-runner.md) · [design](design/app-builder.md).
