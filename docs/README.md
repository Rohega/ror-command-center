...
4. App builder (kit decision, not the warehouse example): [ADR-0006](architecture/adr-0006-app-builder-outside-rorcc-inside.md) · [ADR-0007](architecture/adr-0007-action-runner.md) · [ADR-0008](architecture/adr-0008-security-pass.md) · [ADR-0009](architecture/adr-0009-preview.md) · [ADR-0010](architecture/adr-0010-stack-core.md) · [ADR-0011](architecture/adr-0011-next-stack.md) · [ADR-0012](architecture/adr-0012-external-shell.md) · [design](design/app-builder.md).
